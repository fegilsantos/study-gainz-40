  ...
  public: {
    ...
    Functions: {
      can_access_person_data: {
        Args: { person_id: string } | { person_id: number }
        Returns: boolean
      }
      can_access_subject_performance: {
        Args: {
          subject_performance_row: Database["public"]["Tables"]["Subject Performance"]["Row"]
        }
        Returns: boolean
      }
...
export const Constants = {
  public: {
    Enums: {
      ...
      "Activity type": ["Prova", "Lição de casa", "Projeto", "Revisão", "Aula"],
      Gender: ["Male", "Female", "Other"],
      Priority: [
        "Muito Alta",
        "Alta",
